...
! function(a, b) {
    ...
    return b.prototype = {
            ...
            _generateText: function() {
                if (this._textContainer = document.createElement("div"),
                    ...
                    var a = {
                        ...
                        lineHeight: this._svgSize - 30 + "px"
                    };
                    for (var b in a)
            ...
            htmlifyNumber: function(a, b, c) {
                ...
                if (d.length == 1) {
                    return (e += '.<span class="' + c + '">00%</span><em>' + this._name + "</em>"),
                        e + '<span class="bf">%<span></span><em>' + this._name + '</em>'
                }
                var ss = '';
                if(d[1].length>1){
                    ss=d[1].substring(0, 2);
                }else{
                    ss=d[1].substring(0, 2)+'0';
                }
                return d.length > 1 && (e += '.<span class="' + c + '">' +ss + "%</span><em>" + this._name + "</em>"),
                    e + '<span class="bf">%<span></span><em>' + this._name + '</em>'
            },
