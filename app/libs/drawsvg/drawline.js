    ...
    for (var i = 0; i < nowOption.data.length; i++) {
        ...
        switch (nowOption.xytext.y) {
            case "bottom":
                ...
                break
            case 'middle':
                py = (nowOption.showArr.h + nowOption.top) - nowOption.showArr.h * ((nowOption.y.length - 1) / nowOption.y.length) * ((nowOption.data[i] - nowOption.minY) / (nowOption.maxY - nowOption.minY)) - 0.5 * nowOption.showArr.h / nowOption.y.length
        ...
        if (nowOption.iconImages[i]) {
            if (nowOption.iconImages[i].length != 0) {
                if (nowOption.iconImages[i]) {
                    nowOption.paper.image(nowOption.iconImages[i], stp - 5, py - 6, 10, 10)
                }
            }
        }
