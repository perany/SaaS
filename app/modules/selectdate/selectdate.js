...
function selectMouth() {
    ...
    this.complete = function() {
        ...
        //console.log(this.nowParam.data)
    ...
    //     }
    //     //console.log('---', this.maxDay, this.minDay)
